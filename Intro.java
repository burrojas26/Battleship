...
public class Intro {
    ...
    public String mode() {
        ...
        if (option == 'F') {
            ...
            System.out.println("In your board a 0 represents empty water, while a number from 2 to 5 represents a ship of 2 size, a ship of 3 size, etc. If an X appears on your board that represents a part of a ship that has been hit. A # means that is a place in which the attacker has missed.");
            System.out.println("");
            return "fast";
        }
        else {
